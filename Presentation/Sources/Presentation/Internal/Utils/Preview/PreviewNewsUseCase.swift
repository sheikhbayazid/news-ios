...
extension NewsArticle {
    static let preview1 = NewsArticle(
        source: .init(
            id: nil,
            name: "Apple 1"
        ),
        ...
        urlString: "https://en.wikipedia.org/wiki/Apple_I",
        urlToImage: "https://media.wired.com/photos/66b3cac3a922a7712a7c43e0/191:100/w_1280,c_limit/Crash-Reports-Sec-140000036.jpg",
        publishedAt: .now,
    ...
    static let preview2 = NewsArticle(
        source: .init(
            id: nil,
            name: "Apple 2"
        ),
        ...
        urlString: "https://en.wikipedia.org/wiki/Apple_II",
        urlToImage: nil,
        publishedAt: .now,
